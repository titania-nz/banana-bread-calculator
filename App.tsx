          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <article className="bg-white rounded-warm-lg border border-border p-6 shadow-warm">
                ...
                <section className="mb-6" aria-labelledby="wet-ingredients-heading">
                ...
                <section className="mb-6" aria-labelledby="dry-ingredients-heading">
                ...
                <section className="pt-4 border-t border-border/50" aria-labelledby="optional-ingredients-heading">
                  <h3 id="optional-ingredients-heading" className="text-lg font-semibold text-deep-brown mb-3 flex items-center gap-2" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                    <div className="w-3 h-3 bg-accent rounded-full" aria-hidden="true"></div>
                    Optional Add-ins
                  </h3>
                  <ul className="space-y-2 text-sm" role="list">
                    <li className="flex justify-between py-1 px-3 bg-accent/10 rounded border border-accent/30">
            ...
            {/* Baking Info & Method */}
            <aside className="space-y-6" aria-label="Baking information and instructions">
              {/* Baking Details */}
